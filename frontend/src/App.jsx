...
function App() {
    ...
    const currencyCodes = ["USD", "EUR", "SOS", "CAD","JPY"]; 
    ...
    <div>
        ...
        <section className="converter">
            <form onSubmit={handleSubmit}>
                ...
                <input name="amount" value={formData.amount} onChange={handleChange} placeholder="Amount" type="number" className="input" />
        ...
        <section className="additional-info ">
            ...
            <p>Detailed explanation on advantages or instructions for us.</p>
        </section>
    </div>
  )
}
